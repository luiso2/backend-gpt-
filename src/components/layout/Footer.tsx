  ...
  return (
    <>
      ...
      <div className="footer-newsletter">
        <div className="container-footer">
          <div className="newsletter-content">
            ...
            <Link href="/contact" className="newsletter-button">
              <span className="button-text">{t.footer.newsletter.button}</span>
      ...
      <style jsx>{`
        ...
        /* Newsletter Section */
        .footer-newsletter {
          background: #0F4C3A; /* MERCATOP medium green */
          background-image: linear-gradient(135deg, rgba(184, 233, 45, 0.08) 0%, rgba(230, 255, 92, 0.03) 100%);
          border-bottom: 1px solid rgba(184, 233, 45, 0.1);
          position: relative;
        }
        ...
        .newsletter-button {
          ...
          box-shadow: 
            0 4px 20px rgba(184, 233, 45, 0.3),
            0 0 0 0 rgba(184, 233, 45, 0.4);
          white-space: nowrap;
          position: relative;
          overflow: hidden;
        ...
        .newsletter-button::before {
          ...
          right: 0;
          bottom: 0;
          background: linear-gradient(135deg, #A8D91D 0%, #D6EF4C 100%);
          opacity: 0;
        ...
        .newsletter-button:hover {
          ...
          box-shadow: 
            0 12px 40px rgba(184, 233, 45, 0.5),
            0 0 0 4px rgba(184, 233, 45, 0.2);
          border-color: rgba(184, 233, 45, 0.6);
        }
        ...
        .newsletter-button:hover .button-text {
          text-shadow: 0 1px 2px rgba(10, 46, 31, 0.2);
        }
        ...
        .newsletter-button:hover .button-icon-wrapper {
        ...
        .newsletter-button:hover .button-icon {
          filter: drop-shadow(0 1px 2px rgba(10, 46, 31, 0.2));
        }
